...
const (
	AnalyticsService_GetKPIs_FullMethodName = "/analytics.AnalyticsService/GetKPIs"
)
...
func (UnimplementedAnalyticsServiceServer) GetKPIs(context.Context, *GetKPIsRequest) (*GetKPIsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetKPIs not implemented")
}
...
var AnalyticsService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "apps/analytics-service/pb/analytics.proto",
}
